...
public class task0427 {
    public static void main(String[] args) throws Exception {
        ...
        if (a%2 == 0 && a>0 && a<=9) System.out.println("четное однозначное число");
        if (a%2 != 0 && a>0 && a<=9 ) System.out.println("нечетное однозначное число");
        if (a%2 == 0 && a>9 && a<100) System.out.println("четное двузначное число");
        if (a%2 != 0 && a>9 && a<100) System.out.println("нечетное двузначное число");
        if (a%2 == 0 && a>99 && a<1000) System.out.println("четное трехзначное число");
        if (a%2 != 0 && a>99 && a<1000) System.out.println("нечетное трехзначное число");
